...
import { TextFileConverterTemplate } from "@src/components/templates/TextFileConverter";
...
const TextFileConverterPage = ({ locale, ratingData }: ILocale & IRating) => {
  ...
  return (
    <Layout>
      ...
      <Layout.Main>
        <TextFileConverterTemplate ratingData={ratingData} />
      </Layout.Main>
      <Layout.Footer>
...
export default TextFileConverterPage;
