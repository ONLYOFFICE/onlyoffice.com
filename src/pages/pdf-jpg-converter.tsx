...
import { PDFJPGConverterTemplate } from "@src/components/templates/PDFJPGConverter";
...
const PDFJPGConverterPage = ({ locale, ratingData }: ILocale & IRating) => {
  const { t } = useTranslation("pdf-jpg-converter");
  ...
  return (
    <Layout>
      ...
      <Layout.Main>
        <PDFJPGConverterTemplate ratingData={ratingData} />
      </Layout.Main>
      <Layout.Footer>
...
export default PDFJPGConverterPage;
