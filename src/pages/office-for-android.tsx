...
import { OfficeForAndroidTemplate } from "@src/components/templates/OfficeForAndroid";

const OfficeForAndroidPage = ({ locale }: ILocale) => {
...
export default OfficeForAndroidPage;
