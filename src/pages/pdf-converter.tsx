...
import { PDFConverterTemplate } from "@src/components/templates/PDFConverter";
...
const PDFConverterPage = ({ locale, ratingData }: ILocale & IRating) => {
  const { t } = useTranslation("pdf-converter");
  ...
  return (
    <Layout>
      ...
      <Layout.Main>
        <PDFConverterTemplate ratingData={ratingData} />
      </Layout.Main>
      <Layout.Footer>
