...
import { XLSXPDFConverterTemplate } from "@src/components/templates/XLSXPDFConverter";
...
const XLSXPDFConverterPage = ({ locale, ratingData }: ILocale & IRating) => {
  ...
  return (
    <Layout>
      ...
      <Layout.Main>
        <XLSXPDFConverterTemplate ratingData={ratingData} />
      </Layout.Main>
      <Layout.Footer>
...
export default XLSXPDFConverterPage;
