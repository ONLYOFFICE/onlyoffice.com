...
interface IInstallCanceledData {
  switched_to_the_cloud_version: "0" | "1";
...
export default async function handler(
  ...
  try {
    ...
    if (req.headers.referer) {
      try {
        const installCanceledData: IInstallCanceledData = {
        ...
        await db.teamlabsite.query(
          "INSERT INTO install_cancelled_request SET ?",
          [installCanceledData],
        );
      } catch (error) {
