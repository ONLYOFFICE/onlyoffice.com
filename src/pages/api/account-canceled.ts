...
export default async function handler(
  ...
  try {
    ...
    if (req.headers.referer) {
      try {
        const accountCanceledData: IAccountCanceledData = {
        ...
        await db.teamlabsite.query(
          "INSERT INTO account_cancelled_request SET ?",
          [accountCanceledData],
        );
      } catch (error) {
