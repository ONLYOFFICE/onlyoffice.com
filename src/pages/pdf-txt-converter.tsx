...
import { PDFTXTConverterTemplate } from "@src/components/templates/PDFTXTConverter";
...
const PDFTXTConverterPage = ({ locale, ratingData }: ILocale & IRating) => {
  const { t } = useTranslation("pdf-txt-converter");
  ...
  return (
    <Layout>
      ...
      <Layout.Main>
        <PDFTXTConverterTemplate ratingData={ratingData} />
      </Layout.Main>
      <Layout.Footer>
...
export default PDFTXTConverterPage;
