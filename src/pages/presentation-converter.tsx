...
import { PresentationConverterTemplate } from "@src/components/templates/PresentationConverter";
...
const PresentationConverterPage = ({
  locale,
  ratingData,
}: ILocale & IRating) => {
  const { t } = useTranslation("presentation-converter");
  ...
  return (
    <Layout>
      ...
      <Layout.Main>
        <PresentationConverterTemplate ratingData={ratingData} />
      </Layout.Main>
      <Layout.Footer>
...
export default PresentationConverterPage;
