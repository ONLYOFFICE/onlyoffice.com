...
import { EPUBTXTConverterTemplate } from "@src/components/templates/EPUBTXTConverter";
...
const EPUBTXTConverterPage = ({ locale, ratingData }: ILocale & IRating) => {
  ...
  return (
    <Layout>
      ...
      <Layout.Main>
        <EPUBTXTConverterTemplate ratingData={ratingData} />
      </Layout.Main>
      <Layout.Footer>
...
export default EPUBTXTConverterPage;
