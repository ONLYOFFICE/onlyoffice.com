...
import { PPTXPDFConverterTemplate } from "@src/components/templates/PPTXPDFConverter";
...
const PPTXPDFConverterPage = ({ locale, ratingData }: ILocale & IRating) => {
  const { t } = useTranslation("pptx-pdf-converter");
  ...
  return (
    <Layout>
      ...
      <Layout.Main>
        <PPTXPDFConverterTemplate ratingData={ratingData} />
      </Layout.Main>
      <Layout.Footer>
...
export default PPTXPDFConverterPage;
