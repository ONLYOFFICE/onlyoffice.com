...
import { XLSXCSVConverterTemplate } from "@src/components/templates/XLSXCSVConverter";
...
const XLSXCSVConverterPage = ({ locale, ratingData }: ILocale & IRating) => {
  const { t } = useTranslation("xlsx-csv-converter");
  ...
  return (
    <Layout>
      ...
      <Layout.Main>
        <XLSXCSVConverterTemplate ratingData={ratingData} />
      </Layout.Main>
      <Layout.Footer>
...
export default XLSXCSVConverterPage;
