...
import secureImage from "@public/images/main/security/secure.png";
import secure2xImage from "@public/images/main/security/secure@2x.png";
import securityFeaturesImage from "@public/images/main/security/features.svg";
...
const StyledSecurityFirstImage = styled.div`
  ...
  background-image: url(${secureImage.src});
  ...
  @media only screen and (-webkit-min-device-pixel-ratio: 1.5),
    ...
    background-image: url(${secure2xImage.src});
  }
`;
...
const StyledSecurityFirstFeatures = styled.ul`
  ...
  li {
    width: 64px;
    height: 64px;
    background-image: url(${securityFeaturesImage.src});
    background-repeat: no-repeat;
