...
const StyledRoomHero = styled(Section)`
  margin-top: -72px;
  background-image: url("/images/modules/room/room-hero/bg.svg");
...
const StyledRoomHeroWrapper = styled.div`
  display: grid;
...
const StyledRoomHeroContent = styled.div`
  display: flex;
  align-items: start;
...
const StyledRoomHeroList = styled.ul`
  display: grid;
  align-items: start;
  row-gap: 16px;
  font-size: 16px;
...
const StyledRoomHeroListItem = styled.li`
  position: relative;
  padding-left: 32px;
