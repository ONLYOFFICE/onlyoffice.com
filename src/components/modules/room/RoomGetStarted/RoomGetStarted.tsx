...
import { StyledRoomGetStartedHeading } from "./RoomGetStarted.styled";
...
const RoomGetStarted = () => {
  const { t } = useTranslation("RoomGetStarted");
