...
export const items: IGetStartedItems = {
  items: [
    {
      imgUrl: "/images/modules/room/room-get-started/docspace.svg",
    ...
    {
      imgUrl: "/images/modules/room/room-get-started/connectors.svg",
    ...
    {
      imgUrl: "/images/modules/room/room-get-started/collaboration.svg",
  ...
  largeItems: [
    {
      imgUrl: "/images/modules/room/room-get-started/from-pc.svg",
      heading: "FromYourPC",
    ...
    {
      imgUrl: "/images/modules/room/room-get-started/from-mobile.svg",
