...
export const items: IGetStartedItems = {
  items: [
    {
      imgUrl: "/images/templates/rooms-get-started/docspace.svg",
    ...
    {
      imgUrl:
        "/images/templates/rooms-get-started/connectors.svg",
    ...
    {
      imgUrl:
        "/images/templates/rooms-get-started/collaboration.svg",
