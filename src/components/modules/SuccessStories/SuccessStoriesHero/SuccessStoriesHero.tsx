...
} from "@src/components/modules/SuccessStories/SuccessStoriesHero/SuccessStoriesHero.styled";

const SuccessStoriesHero: FC<ISlugProps> = ({ slug }) => {
