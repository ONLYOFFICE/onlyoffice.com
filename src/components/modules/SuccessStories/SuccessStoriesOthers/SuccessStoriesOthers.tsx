...
import {
  ISlugProps,
  ISuccessStoriesData,
} from "@src/components/modules/SuccessStories/SuccessStories.types";
...
} from "@src/components/modules/SuccessStories/SuccessStoriesOthers/SuccessStoriesOthers.styled";

const SuccessStoriesOthers: FC<ISlugProps> = ({ slug }) => {
