...
Default.args = {
  ...
  items: [
    {
      icon: {
        url: "/images/storybook/modules/best-alternative/best-alternative-reasons/open_source.svg",
      },
      heading: "Open-source",
    ...
    {
      icon: {
        url: "/images/storybook/modules/best-alternative/best-alternative-reasons/desktop_app.svg",
      },
    ...
    {
      icon: {
        url: "/images/storybook/modules/best-alternative/best-alternative-reasons/seamless.svg",
      },
    ...
    {
      icon: {
        url: "/images/storybook/modules/best-alternative/best-alternative-reasons/ai_helper.svg",
      },
      heading: "AI helper",
