...
import { StyledGetStartedHeading } from "./BestAlternativeGetStarted.styled";
...
const BestAlternativeGetStarted = () => {
  const { t } = useTranslation("BestAlternativeGetStarted");
...
export { BestAlternativeGetStarted };
