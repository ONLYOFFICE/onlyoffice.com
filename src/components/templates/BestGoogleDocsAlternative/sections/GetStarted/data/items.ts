...
export const items: IGetStartedItems = {
  items: [
    {
      imgUrl: "/images/templates/best-google-docs-alternative/get-started/docspace.svg",
    ...
    {
      imgUrl: "/images/templates/best-google-docs-alternative/get-started/connectors.svg",
    ...
    {
      imgUrl: "/images/templates/best-google-docs-alternative/get-started/developers.svg",
  ...
  largeItems: [
    {
      imgUrl: "/images/templates/best-google-docs-alternative/get-started/from-pc.svg",
      heading: "FromYourPC",
    ...
    {
      imgUrl: "/images/templates/best-google-docs-alternative/get-started/from-mobile.svg",
