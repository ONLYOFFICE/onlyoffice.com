...
const StyledCompatibilityCompanySwitcherItem = styled.button<{
  ...
  &::before {
    ...
    background-image: ${({ $type }) =>
      $type === "onlyOffice"
        ? "url('/images/templates/best-google-docs-alternative/compatibility/logo_onlyoffice.svg')"
        : $type === "googleDocs"
        ? "url('/images/templates/best-google-docs-alternative/compatibility/logo_google_docs.svg')"
        : undefined};
  }
`;
