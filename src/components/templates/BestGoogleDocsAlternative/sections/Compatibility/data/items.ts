...
export const items: ICompatibilityItem[] = [
  ...
  },
  {
    ...
    src: getAssetUrl("/images/templates/best-google-docs-alternative/compatibility/pdf/google_docs_docx.pdf"),
  },
  {
    type: "alternativeXlsx",
    src: getAssetUrl("/images/templates/best-google-docs-alternative/compatibility/pdf/google_docs_xlsx.pdf"),
  },
];
