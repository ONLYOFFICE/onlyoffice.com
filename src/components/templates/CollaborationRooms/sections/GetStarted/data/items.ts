...
export const items: IGetStarted = {
  items: [
    {
      imgUrl: "/images/templates/collaboration-rooms/get-started/docspace.svg",
    ...
    {
      imgUrl:
        "/images/templates/collaboration-rooms/get-started/connectors.svg",
    ...
    {
      imgUrl:
        "/images/templates/collaboration-rooms/get-started/collaboration.svg",
