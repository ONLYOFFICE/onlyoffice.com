...
export const items: IGetStartedItems = {
  items: [
    {
      imgUrl: "/images/templates/document-editor-comparison/get-started/docspace.svg",
    ...
    {
      imgUrl: "/images/templates/document-editor-comparison/get-started/connectors.svg",
    ...
    {
      imgUrl: "/images/templates/document-editor-comparison/get-started/developers.svg",
  ...
  largeItems: [
    {
      imgUrl: "/images/templates/document-editor-comparison/get-started/from-pc.svg",
      heading: "FromYourPC",
    ...
    {
      imgUrl: "/images/templates/document-editor-comparison/get-started/from-mobile.svg",
