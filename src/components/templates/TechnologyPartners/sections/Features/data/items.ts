export const items = [
  {
    title: "IntegrateOnline",
    description: "BringCollaborative",
    linkUrl: "/all-connectors.aspx?from=technologypartners",
    linkText: "ExploreExisting",
    button1Text: "TryNow",
  ...
  },
  {
    ...
    description: "ConsiderYourWebService",
    linkUrl: "/app-directory",
    target: "_blank",
    linkText: "ExploreAvailable",
    button1Text: "SendRequest",
    button2Text: "LearnMore",
    btnLinkPrimary: "mailto:sales@onlyoffice.com",
