...
const StyledQuestionsContainer = styled(Container)`
  ...
  &::after {
    ...
    width: 246px;
    height: 215px;
    background-image: url(${getAssetUrl('/images/templates/automation-api/questions/letter.svg')});
...
const StyledQuestionsWrapper = styled.div`
  ...
  &::before {
    ...
    width: 48px;
    height: 48px;
    background-image: url(${getAssetUrl('/images/templates/automation-api/questions/question.svg')});
    background-repeat: no-repeat;
  }
