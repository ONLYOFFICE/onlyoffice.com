          ...
          <StyledMarketplaceConnectorBody>
            ...
            <Text size={1} color="#ffffff">
              <Trans
                ...
                components={[<a key="0" href="https://github.com/ONLYOFFICE/onlyoffice-suitecrm/releases" target="_blank" style={{ color: '#fff' }} />]}
              />
            </Text>
            <Button
              ...
              as="a"
              target="_blank"
              href="https://github.com/ONLYOFFICE/onlyoffice-suitecrm/releases"
              label={t("GetItNow")}
            />
          </StyledMarketplaceConnectorBody>
          <StyledMarketplaceConnectorImg />
