...
const StyledMarketplaceConnector = styled.section`
  ...
  &::after {
    ...
    width: 691px;
    height: 678px;
    background-image: url("/images/templates/office-for-suitecrm/marketplace-connector/bg.svg");
...
const StyledMarketplaceConnectorImg = styled.div`
  ...
  max-width: 328px;
  height: 100%;
  background-image: url("/images/templates/office-for-suitecrm/marketplace-connector/apps.svg");
  background-repeat: no-repeat;
