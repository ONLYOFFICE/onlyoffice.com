...
const StyledMarketplaceConnector = styled.section`
  ...
  &::after {
    ...
    width: 508px;
    height: 522px;
    background-image: url(${getAssetUrl('/images/templates/office-for-redmine/marketplace-connector/bg.svg')});
...
const StyledMarketplaceConnectorImg = styled.div`
  ...
  max-width: 328px;
  height: 100%;
  background-image: url(${getAssetUrl('/images/templates/office-for-redmine/marketplace-connector/apps.svg')});
  background-repeat: no-repeat;
