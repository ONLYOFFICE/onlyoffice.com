...
const StyledHero = styled(Section)`
  ...
  background-image: url(${getAssetUrl('/images/templates/office-for-owncloud/hero/bg.svg')});
...
const StyledHeroLogo = styled.div`
  ...
  width: 98px;
  height: 56px;
  background-image: url(${getAssetUrl('/images/templates/office-for-owncloud/hero/logo.svg')});
  background-repeat: no-repeat;
