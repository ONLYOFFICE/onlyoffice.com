...
export const items: IStepCarouselItem[] = [
  {
    imgUrl: getAssetUrl("/images/templates/office-for-sharepoint/how-to-start/step1.svg"),
  ...
  {
    imgUrl: getAssetUrl("/images/templates/office-for-sharepoint/how-to-start/step2.svg"),
  ...
  {
    imgUrl: getAssetUrl("/images/templates/office-for-sharepoint/how-to-start/step3.svg"),
