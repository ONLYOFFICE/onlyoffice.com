...
const StyledFeaturesWrapper = styled.div`
    ...
    background-image: url("/images/templates/document-builder/features/bg_technology.svg");
    ...
    &:nth-child(2) {
        background-image: url("/images/templates/document-builder/features/bg_languages.svg");
