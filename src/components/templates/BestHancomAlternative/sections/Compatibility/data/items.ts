...
export const items: ICompatibilityItem[] = [
  ...
  },
  {
    ...
    src: getAssetUrl("/images/templates/best-hancom-alternative/compatibility/pdf/hancom_docx.pdf"),
  },
  {
    type: "alternativeXlsx",
    src: getAssetUrl("/images/templates/best-hancom-alternative/compatibility/pdf/hancom_xlsx.pdf"),
  },
];
