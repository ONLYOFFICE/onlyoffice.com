...
export const items: ICompatibilityItem[] = [
  ...
  },
  {
    ...
    src: getAssetUrl("/images/templates/best-microsoft-office-alternative/compatibility/pdf/ms_office_docx.pdf"),
  },
  {
    type: "alternativeXlsx",
    src: getAssetUrl("/images/templates/best-microsoft-office-alternative/compatibility/pdf/ms_office_xlsx.pdf"),
  },
];
