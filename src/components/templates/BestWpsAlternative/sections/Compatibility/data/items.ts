...
export const items: ICompatibilityItem[] = [
  ...
  },
  {
    ...
    src: getAssetUrl("/images/templates/best-wps-alternative/compatibility/pdf/wps_docx.pdf"),
  },
  {
    type: "alternativeXlsx",
    src: getAssetUrl("/images/templates/best-wps-alternative/compatibility/pdf/wps_xlsx.pdf"),
  },
];
