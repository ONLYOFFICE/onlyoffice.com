          ...
          <StyledMarketplaceConnectorBody>
            ...
            <Text size={1} color="#ffffff">
              <Trans
                ...
                components={[<a key="0" href="https://market.strapi.io/plugins/onlyoffice-strapi" target="_blank" style={{ color: '#fff', textDecoration: 'underline' }} />, <a key="1" href="https://www.npmjs.com/package/onlyoffice-strapi" target="_blank" style={{ color: '#fff', textDecoration: 'underline' }} />]}
              />
            </Text>
            <Button
              variant="quaternary"
              ...
              as="a"
              target="_blank"
              href="https://market.strapi.io/plugins/onlyoffice-strapi"
              label={t("GetItNow")}
            />
          </StyledMarketplaceConnectorBody>
          <StyledMarketplaceConnectorImg />
