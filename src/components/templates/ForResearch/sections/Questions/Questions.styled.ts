...
const StyledQuestionsContainer = styled(Container)`
  ...
  &::after {
    ...
    width: 246px;
    height: 215px;
    background-image: url(${getAssetUrl('/images/templates/for-research/questions/mail.svg')});
...
const StyledQuestionsWrapper = styled.div`
  ...
  &::before {
    ...
    width: 64px;
    height: 64px;
    background-image: url(${getAssetUrl('/images/templates/for-research/questions/contact_us.svg')});
    background-repeat: no-repeat;
