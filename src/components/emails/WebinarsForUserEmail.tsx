...
> = {
  en: {
    ...
    ThisEmailIsGeneratedAutomatically: "This email is generated automatically and you do not need to answer it.",
  ...
  de:{
    ...
    ONLYOFFICETeam: "ONLYOFFICE Team",
    ThisEmailIsGeneratedAutomatically: "Diese E-Mail wird automatisch generiert und erfordert keine Antwort.",
  ...
  es:{
    ...
    ThisEmailIsGeneratedAutomatically: "Este correo electrónico se ha generado automáticamente y no es necesario que lo respondas.",
  ...
  fr:{
    ...
    ThisEmailIsGeneratedAutomatically: "Ce courriel a été généré automatiquement. Merci de ne pas y répondre.",
  ...
  it:{
    ...
    ThisEmailIsGeneratedAutomatically: "Questo messaggio è stato generato automaticamente, ti preghiamo pertanto di non rispondere a questa e-mail.",
  ...
  ja:{
    ...
    ThisEmailIsGeneratedAutomatically: "このメールは自動的に生成されるため、返信する必要はありません。",
  ...
  nl:{
    ...
    ONLYOFFICETeam: "ONLYOFFICE Team",
    ThisEmailIsGeneratedAutomatically: "Deze e-mail wordt automatisch gegenereerd en u hoeft deze niet te beantwoorden..",
  ...
  pt:{
    ...
    ThisEmailIsGeneratedAutomatically: "Este email é gerado automaticamente, não precisa respondê-lo.",
  ...
  ru: {
    ...
    ThisEmailIsGeneratedAutomatically: "Это письмо создано автоматически, отвечать на него не нужно.",
  ...
  cs: {
    ...
    ThisEmailIsGeneratedAutomatically: "Tento e-mail je generován automaticky a nemusíte na něj odpovídat.",
                        ...
                        <tbody>
                            <tr border="0" cellspacing="0" cellpadding="0">
                                <td class="fol" style="color: #666666; font-family: 'Open Sans', Helvetica, Arial, Tahoma;  font-size: 13px; line-height: 19.5px; margin: 0; padding: 0px 24px 40px; vertical-align: top;">
                                    ...
                                    <br>
                                    <a href="https://www.onlyoffice.com/Unsubscribe?id=$unsubscribeId" style="color: #FF6F3D;text-decoration: underline;white-space: nowrap;" target="_blank">${t("Unsubscribe")}</a>
                                    </p>
                                </td>
                            </tr>
                        </tbody>
