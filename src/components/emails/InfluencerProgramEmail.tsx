interface IInfluencerProgramEmail {
  fromPage: string;
  fullName: string;
  email: string;
  linkToInfluencer: string;
  moreDetails: string;
  errorText: string;
}

const InfluencerProgramEmail = ({
  fromPage,
  fullName,
  email,
  linkToInfluencer,
  moreDetails,
  errorText,
}: IInfluencerProgramEmail) => {
  return `<body style="margin: 0; padding: 0; text-align: center; width: 100%; font-family: Arial, sans-serif; font-size: 14px; color: #333;">
        ...
        <tr border="0" cellspacing="0" cellpadding="0">
          <td style="margin: 0; padding: 15px 30px 15px; background-color: #f6f6f6; -moz-border-radius: 6px; -webkit-border-radius: 6px; border-radius: 6px;">
            <div style="font-family: Arial; font-size: 14px; line-height: 18px; color: #333; margin: 0; padding: 0; width: 540px; height: auto; overflow: hidden; word-wrap: break-word; vertical-align: top; text-align: left; border: 0 none;">
                          ...
                          <p style="margin-top:5px;">
                              <b>Link to your website/blog/social media</b><br/>
                              ${linkToInfluencer}
                          </p>
                          <p style="margin-top:5px;">
                              <b>More details</b><br/>
