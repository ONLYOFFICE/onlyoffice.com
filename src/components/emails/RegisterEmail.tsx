                    ...
                    <tbody>
                      ...
                      <tr border="0" cellspacing="0" cellpadding="0">
                        <td style="margin: 0; padding-top: 40px;">
                          <table
                            align="center"
                            style="border-collapse: collapse; border: 0; border-spacing: 0; empty-cells: show; font-size: 14px; Margin: 0 auto; max-width: ${language === "zh" ? `200px` : `240px;`} padding: 0; text-align: center; vertical-align: top; width: 100%;"
                            cellspacing="0"
                            cellpadding="0"
                          >
                            <tbody>
